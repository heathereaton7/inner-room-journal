...
export default function App(){
  ...
  return null;
}cd "/Volumes/Heathers Samsung T7/INNER ROOM JOURNAL APP/inner-room-journal" && git add . && git commit -m "Add real app" && git push https://heathereaton7:ghp_o7q71wGEZJh9LilMBotWeEVtG8m5DR1pWXNm@github.com/heathereaton7/inner-room-journal.git main --force
