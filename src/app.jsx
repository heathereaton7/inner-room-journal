...
export default function App(){
  ...
  if(screen==="welcome") return(
    <div style={{minHeight:"100vh",width:"100%",position:"relative",overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-end"}}>
      ...
      {/* Upper floor windows */}
      <div style={{position:"absolute",left:"30%",top:"18%",width:"10%",height:"7%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.50) 0%,rgba(255,160,40,0.15) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.5s ease-in-out infinite"}}/>
      <div style={{position:"absolute",left:"42%",top:"17%",width:"8%",height:"6%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.45) 0%,rgba(255,160,40,0.14) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 4s ease-in-out infinite",animationDelay:"0.6s"}}/>
      <div style={{position:"absolute",left:"60%",top:"18%",width:"10%",height:"7%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.50) 0%,rgba(255,160,40,0.15) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.8s ease-in-out infinite",animationDelay:"1s"}}/>
      {/* Lower floor windows */}
      <div style={{position:"absolute",left:"25%",top:"36%",width:"8%",height:"8%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.55) 0%,rgba(255,155,35,0.18) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.2s ease-in-out infinite",animationDelay:"0.4s"}}/>
      <div style={{position:"absolute",left:"63%",top:"36%",width:"8%",height:"8%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.55) 0%,rgba(255,155,35,0.18) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.6s ease-in-out infinite",animationDelay:"1.2s"}}/>
      <div style={{position:"absolute",left:"72%",top:"36%",width:"7%",height:"7%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.48) 0%,rgba(255,155,35,0.15) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 4.2s ease-in-out infinite",animationDelay:"0.8s"}}/>
