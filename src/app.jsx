...
export default function App(){
  ...
  const CSS=`
    ...
    @keyframes lanternFlicker{0%{opacity:0.55;transform:scale(1)}12%{opacity:0.85;transform:scale(1.06)}28%{opacity:0.6;transform:scale(0.97)}42%{opacity:0.95;transform:scale(1.08)}58%{opacity:0.5;transform:scale(0.95)}70%{opacity:0.9;transform:scale(1.04)}85%{opacity:0.55;transform:scale(1.01)}100%{opacity:0.55;transform:scale(1)}}
    @keyframes windowGlow{0%,100%{opacity:0.4;transform:scale(1)}30%{opacity:0.7;transform:scale(1.03)}60%{opacity:0.5;transform:scale(0.98)}80%{opacity:0.75;transform:scale(1.02)}}
  ...
  if(screen==="welcome") return(
    <div style={{minHeight:"100vh",width:"100%",position:"relative",overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-end"}}>
      ...
      {/* ── Bridge lanterns — 4 lanterns on the wooden bridge ── */}
      <div style={{position:"absolute",left:"28%",top:"76%",width:"5%",height:"4%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,180,60,0.50) 0%,rgba(255,140,30,0.15) 45%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.2s ease-in-out infinite"}}/>
      <div style={{position:"absolute",left:"36%",top:"74%",width:"5%",height:"4%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,180,60,0.50) 0%,rgba(255,140,30,0.15) 45%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.5s ease-in-out infinite",animationDelay:"0.4s"}}/>
      <div style={{position:"absolute",left:"56%",top:"74%",width:"5%",height:"4%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,180,60,0.50) 0%,rgba(255,140,30,0.15) 45%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.3s ease-in-out infinite",animationDelay:"0.8s"}}/>
      <div style={{position:"absolute",left:"64%",top:"76%",width:"5%",height:"4%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,180,60,0.50) 0%,rgba(255,140,30,0.15) 45%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.6s ease-in-out infinite",animationDelay:"1.2s"}}/>

      {/* ── Porch lanterns — flanking the cabin door ── */}
      <div style={{position:"absolute",left:"33%",top:"42%",width:"6%",height:"5%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,190,70,0.55) 0%,rgba(255,150,40,0.18) 45%,transparent 70%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.0s ease-in-out infinite",animationDelay:"0.3s"}}/>
      <div style={{position:"absolute",left:"58%",top:"42%",width:"6%",height:"5%",borderRadius:"50%",background:"radial-gradient(circle,rgba(255,190,70,0.55) 0%,rgba(255,150,40,0.18) 45%,transparent 70%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 2.4s ease-in-out infinite",animationDelay:"0.7s"}}/>

      {/* ── Cabin windows — warm interior glow flickering ── */}
      {/* Upper floor windows */}
      <div style={{position:"absolute",left:"30%",top:"18%",width:"10%",height:"7%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.30) 0%,rgba(255,160,40,0.08) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.5s ease-in-out infinite"}}/>
      <div style={{position:"absolute",left:"42%",top:"17%",width:"8%",height:"6%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.28) 0%,rgba(255,160,40,0.08) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 4s ease-in-out infinite",animationDelay:"0.6s"}}/>
      <div style={{position:"absolute",left:"60%",top:"18%",width:"10%",height:"7%",borderRadius:"20%",background:"radial-gradient(ellipse,rgba(255,200,80,0.30) 0%,rgba(255,160,40,0.08) 55%,transparent 75%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.8s ease-in-out infinite",animationDelay:"1s"}}/>
      {/* Lower floor windows */}
      <div style={{position:"absolute",left:"25%",top:"36%",width:"8%",height:"8%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.35) 0%,rgba(255,155,35,0.10) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.2s ease-in-out infinite",animationDelay:"0.4s"}}/>
      <div style={{position:"absolute",left:"63%",top:"36%",width:"8%",height:"8%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.35) 0%,rgba(255,155,35,0.10) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 3.6s ease-in-out infinite",animationDelay:"1.2s"}}/>
      <div style={{position:"absolute",left:"72%",top:"36%",width:"7%",height:"7%",borderRadius:"15%",background:"radial-gradient(ellipse,rgba(255,195,75,0.30) 0%,rgba(255,155,35,0.08) 50%,transparent 72%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"windowGlow 4.2s ease-in-out infinite",animationDelay:"0.8s"}}/>

      {/* ── Water reflection shimmer ── */}
      <div style={{position:"absolute",left:"20%",top:"82%",width:"55%",height:"10%",borderRadius:"40%",background:"radial-gradient(ellipse at 50% 40%,rgba(255,190,80,0.08) 0%,transparent 65%)",zIndex:1,pointerEvents:"none",mixBlendMode:"screen",animation:"lanternFlicker 3s ease-in-out infinite",animationDelay:"0.5s"}}/>
